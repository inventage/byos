...
public class Category extends TableImpl<CategoryRecord> {
    ...
    /**
     * The column <code>public.category.parent_category_id</code>.
     */
    public final TableField<CategoryRecord, Integer> PARENT_CATEGORY_ID = createField(DSL.name("parent_category_id"), SQLDataType.INTEGER, this, "");
